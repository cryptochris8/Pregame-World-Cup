...
class PlayerPhoto extends StatelessWidget {
  ...
  factory PlayerPhoto.fromPlayer(
    Player player, {
    double size = 80,
    bool circular = false,
  ...
  Widget build(BuildContext context) {
    final container = Container(
      width: size,
      height: circular ? size : size * 1.2, // Slightly taller for rectangular
...
class CircularPlayerPhoto extends StatelessWidget {
  final String? photoUrl;
  final String? playerName;
  final double size;
  ...
  factory CircularPlayerPhoto.fromPlayer(
    Player player, {
    double size = 60,
    Color? borderColor,
    double borderWidth = 2,
  }) {
    return CircularPlayerPhoto(
      photoUrl: player.photoUrl,
      playerName: player.commonName,
      size: size,
