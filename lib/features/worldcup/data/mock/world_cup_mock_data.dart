...
class WorldCupMockData {
  ...
  static final List<NationalTeam> teams = [
    ...
    _team('ITA', 'Italy', 'ITA', Confederation.uefa, 9, 'B', 4, false,
    ...
    _team('DEN', 'Denmark', 'DEN', Confederation.uefa, 21, 'A', 0, false,
    ...
    _team('IDN', 'Indonesia', 'IDN', Confederation.afc, 130, 'F', 0, false,
        coach: 'Shin Tae-yong', nickname: 'Garuda', captain: 'Asnawi Mangkualam',
        primaryColor: '#FF0000', secondaryColor: '#FFFFFF',
        stars: ['Asnawi Mangkualam', 'Pratama Arhan', 'Nathan Tjoe-A-On', 'Rafael Struick'],
        appearances: 0, bestFinish: 'First appearance'),
  ...
  static List<WorldCupGroup> get groups {
    return [
      _createGroup('A', [
        ...
        _standing('DEN', 'Denmark', 3, 3, 1, 1, 1, 3, 3),
        _standing('RSA', 'South Africa', 4, 3, 0, 0, 3, 1, 5),
      ]),
      _createGroup('B', [
        _standing('ITA', 'Italy', 1, 3, 3, 0, 0, 7, 1),
