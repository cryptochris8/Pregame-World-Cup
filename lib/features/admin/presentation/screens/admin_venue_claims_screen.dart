      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildInfoRow(Icons.badge, 'Role', ownerRole),
            _buildInfoRow(Icons.email, 'Email', contactEmail),
            if (contactPhone.isNotEmpty) _buildInfoRow(Icons.phone, 'Phone', contactPhone),
            _buildInfoRow(Icons.category, 'Type', venueType),
            _buildInfoRow(Icons.key, 'Venue ID', venueId),
            if (claimedAt != null)
              _buildInfoRow(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 12),
            _buildInfoRow(Icons.key, 'Venue ID', venueId),
            _buildInfoRow(Icons.person, 'Disputer', disputerId),
            _buildInfoRow(Icons.person_outline, 'Current Owner', currentOwnerId),
            if (details.isNotEmpty) _buildInfoRow(Icons.notes, 'Details', details),
            if (createdAt != null)
              _buildInfoRow(
                Icons.calendar_today,
                'Filed',
